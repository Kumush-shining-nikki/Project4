  ...
  var e = {
      ...
      4530: (e, t, n) => {
        ...
        var r = n(6881),
          ...
          y = (e.exports = function (e, t, n) {
            ...
            return (
              a(r, "source") ||
                (r.source = b(w, "string" == typeof t ? t : "")),
              e
            );
          });
      ...
      7182: (e, t, n) => {
        ...
        var r = n(5613),
          ...
          w = function () {
            ...
            var e = arguments.length,
              ...
              o = new b(t);
            return (
              (o.name = v), s(r, "stack", a(1, f(o.stack, 1))), l(r, this, w), r
            );
          },
        ...
        var k = i(v),
          C = k.prototype;
        if (C.constructor !== k)
          for (var T in (h || s(C, "constructor", a(1, k)), p))
            if (c(p, T)) {
              var I = p[T],
                O = I.s;
              c(k, O) || s(k, O, a(6, I.c));
            ...
            r(
              ...
              function (e) {
                ...
                d(this, function (e, t) {
                  ...
                  a(t, 1);
                for (
                  var o, s = i(e), c = i(n), f = 0, m = 0, h = !1, v = r.length;
                  f < v;

                )
                  (o = r[f++]),
                    h || o.key === s ? ((h = !0), l(this, o.key)) : m++;
                for (; m < v; )
                  ((o = r[m++]).key === s && o.value === c) ||
    ...
    (() => {
      ...
      function h(e, t, n) {
        ...
        window.ShopifyAnalytics &&
          ...
          window.ShopifyAnalytics.lib.track(n || r, { ...o }, void 0, void 0, {
            addApiSource: t,
            shopifyEmitted: !0,
          });
      }
      ...
      function w(e, t, n) {
        ...
        if (r && o.length > 0)
          return (n[r] = n[r] || {}), void w(o.join("."), t, n[r]);
        const i = /(\w+)?\[(\d+)?\](.+)?/.exec(e);
        if (i) {
          const [e, r, o, a = ""] = i;
      ...
      function E(e) {
        ...
        if (
          "function" !=
          typeof (null === (o = window.ShopifyAnalytics) ||
          void 0 === o ||
          null === (i = o.lib) ||
          void 0 === i
            ? void 0
      ...
      function O(t, { cart: n }) {
        try {
          ...
          window.localStorage.setItem(i, r),
            null == n ||
              n.lines.forEach((n) => {
      ...
      class L {
          ...
          if (!(e.xhr.status >= 400))
            try {
              ...
              if (
                ...
                const t = g(e.body);
                o = T(e.publish, t, e.initData, "add-xhr-redirect");
              }
              if (o) return;
              n.match(N)
                ? L.parsePayloadResponse(e, (t) => {
        ...
        static parsePayloadResponse(e, t) {
          e.xhr.response instanceof Blob
            ? L.parseBlobToJson(e.xhr.response, t)
                  ...
                  .then((e) => {
                    ...
                    if (
                      (i.match(N) &&
                        ...
                        r.body &&
                        e.redirected &&
                        ((a = g(arguments[1].body)),
                        (s = T(t, a, n, "add-fetch-redirect"))),
                      s)
                    )
                      return e;
                    try {
                  ...
                  if (
                    ...
                    try {
                      ...
                      if (
                        ...
                        return void h(d, "add-form", a);
                      t(e, { cartLine: d }), v(d, "add-form");
                    } catch (s) {
      ...
      const $ = {
        ...
        z = { NO_VALUE: "", ACCEPTED: "1", DECLINED: "0" },
        V = {
          PREFERENCES: "p",
          ANALYTICS: "a",
          MARKETING: "m",
      ...
      function ge(e) {
        ...
        return {
          query: `query { consentManagement { cookies(${pe({
            visitorConsent: {
      ...
      function we(e, t, n) {
        const r = t.granular_consent,
          ...
          s = {
            headers: {
              ...
              [a]: o,
              ...(H() ? { "x-test-payload": JSON.stringify(t) } : {}),
            },
        ...
        return fetch(`https://${i}/api/unstable/graphql.json`, s)
          ...
          .then((o) => {
            ...
            return (
              Z(X, l, s, p),
              f && m && (Z(ve, l, c, f), Z(be, l, c, m)),
              d !== l &&
                (Z(X, d, s, p), f && m && (Z(ve, d, c, f), Z(be, d, c, m))),
              void 0 !== t.granular_consent &&
                (function (e) {
                  const t = e[V.MARKETING],
                    ...
                    o = e[V.PREFERENCES];
                  !0 === t
                    ? de($.MARKETING_ACCEPTED)
                    : !1 === t && de($.MARKETING_DECLINED),
                    !0 === n
                      ? de($.SALE_OF_DATA_ACCEPTED)
                      : !1 === n && de($.SALE_OF_DATA_DECLINED),
                    !0 === r
                      ? de($.ANALYTICS_ACCEPTED)
                      : !1 === r && de($.ANALYTICS_DECLINED),
                    !0 === o
                      ? de($.PREFERENCES_ACCEPTED)
                      : !1 === o && de($.PREFERENCES_DECLINED);
                  const i = (function (e) {
                    return {
                  ...
                  const a = [r, o, t, n];
                  a.every((e) => !0 === e) && de($.TRACKING_ACCEPTED),
                    a.every((e) => !1 === e) && de($.TRACKING_DECLINED);
                })({
                  [V.PREFERENCES]: ae(),
                  [V.ANALYTICS]: se(),
                  [V.MARKETING]: ce(),
              ...
              (function (e, t) {
                ...
                const n = (function (e) {
                  const t = new URL(e, window.location.origin),
                    n = me(e)
                      ? fe(t)
                      : fe(t).replace(window.location.origin, "");
      ...
      class ye {
        ...
        produce(e, t) {
          if (this.instrumentationEnabled() && se())
            try {
              const n = {
              ...
              (function (e, t) {
                if (
                  ...
                  ((null == t ? void 0 : t.analyticsFramework) !== Re &&
                    (null == t ? void 0 : t.analyticsFramework) !== Ne &&
                    (null == t ? void 0 : t.analyticsFramework) !== De &&
                    (null == t ? void 0 : t.analyticsFramework) !== Pe)
                )
                  return $e(Ie);
                const n =
      ...
      const Be = "webPixelsManager",
        ...
        He = "0.0.475",
        We = "modern",
        Ye = "e6387955w1e097182p885e99f9m4df35400",
        Xe = "be6387955w1e097182p885e99f9m4df35400m.js",
        Ge = "loggedConversion2",
        Je = "WebPixel::Render",
        Ze = "web-pixels-manager-sandbox-container",
        Qe = "isMerchantSession",
        et = () => {
          let e, t;
          return {
      ...
      const st = {
        ...
        ct = (function () {
          const e = ["modern", "legacy", "bot", "unknown"];
          try {
            const t = document.currentScript?.dataset?.browserTarget;
          ...
          notify: (e, t) => {
            try {
              ...
              const a = (function (
                ...
                s = st[Ke];
              if (!s) return void console?.log(`[${Ke}]`, "Bugsnag notify:", a);
              fetch(s, {
                method: "POST",
                headers: {
                  "Content-Type": "application/json",
      ...
      let mt = !1;
      const ht = ["analytics", "preferences", "marketing", "sale_of_data"];
      function vt(e, t) {
        return e ? !t || Object.keys(e).every((n) => !e[n] || t[n]) : Ee();
      }
      function bt(e) {
        const { promise: t, resolve: n } = et(),
          r = {
            analytics: Ae(),
            marketing: Se(),
            preferences: ke(),
      ...
      const Et = {},
        _t = {
          ...
          "page:session": {
            start: { name: "start", params: Et },
            end: { name: "page:unload", params: Et },
          },
          completed: {
            start: { name: "start", params: Et },
            end: { name: "pixels:resolved", params: Et },
          },
        };
      function St(e, t = Et) {
        const n = At(e, "end", t),
      ...
      function Ut(e, t = !1) {
        const n = {
          ...
          metadata: { event_created_at_ms: Vt() },
        };
        $t.push(n), t ? zt() : void 0 === jt && (jt = setTimeout(zt, Lt));
      }
      function Ft(e, t, n = !1) {
        Ut(It(e, t), n);
      }
      function zt({ skipXhr: e } = { skipXhr: !1 }) {
        if (((jt = void 0), 0 === $t.length)) return;
        const t = [...$t];
        ($t.length = 0),
          (function (e, t) {
            if (0 === e.length) return !1;
            const n = { metadata: { event_sent_at_ms: Vt() }, events: e };
            !(function (e, t) {
              const n = `${(function (e) {
                const t = {
                  global: "https://monorail-edge.shopifysvc.com",
                  wellKnown: `${Rt}/.well-known/shopify/monorail`,
                  staging: "https://monorail-edge-staging.shopifycloud.com",
                  test: "https://localhost",
                };
                return "production" !== Ke && "global" === e
                  ? t.staging
                  : t[e || "wellKnown"];
              })(Mt)}${Pt}`;
              try {
      ...
      const Wt = [];
      for (let n = 0; n < 256; ++n) Wt.push((n + 256).toString(16).slice(1));
      const Yt = function (e, t, n) {
        if (qt.randomUUID && !t && !e) return qt.randomUUID();
        const r = (e = e || {}).random || (e.rng || Ht)();
      ...
      const Qt = (e) => ("number" == typeof e ? new Zt(e) : new Map()),
        en = (...e) => JSON.stringify(e);
      function tn(e, { cache: t, cacheKey: n = en } = {}) {
        function r(...t) {
          const o = r.cache,
            i = n.apply(this, t);
      ...
      const gn = Symbol.for("RemoteUi::Retain"),
        wn = Symbol.for("RemoteUi::Release"),
        yn = Symbol.for("RemoteUi::RetainedBy");
      class xn {
        constructor() {
          this.memoryManaged = new Set();
        }
        add(e) {
          this.memoryManaged.add(e), e[yn].add(this), e[gn]();
        }
        release() {
          for (const e of this.memoryManaged) e[yn].delete(this), e[wn]();
          this.memoryManaged.clear();
        }
      }
      function En(e) {
        return Boolean(e && e[gn] && e[wn]);
      }
      function _n(e, { deep: t = !0 } = {}) {
        return Sn(e, t, new Map());
      }
      function Sn(e, t, n) {
        const r = n.get(e);
        if (null != r) return r;
        const o = En(e);
        if ((o && e[gn](), n.set(e, o), t)) {
          if (Array.isArray(e)) {
            const r = e.reduce((e, r) => Sn(r, t, n) || e, o);
            return n.set(e, r), r;
          }
          if (An(e)) {
            const r = Object.keys(e).reduce((r, o) => Sn(e[o], t, n) || r, o);
            return n.set(e, r), r;
          }
        }
        return n.set(e, o), o;
          ...
          if ("object" == typeof t) {
            ...
            if (kn in t) {
              ...
              Object.defineProperties(l, {
                [wn]: { value: s, writable: !1 },
                [gn]: { value: c, writable: !1 },
                [yn]: { value: u, writable: !1 },
              });
      ...
      function Pn(
        e,
        { uuid: t = Ln, createEncoder: n = Cn, callable: r } = {}
      ) {
        let o = !1,
          i = e;
        const a = new Map(),
        ...
        return (
          i.addEventListener("message", d),
          {
            ...
            terminate() {
              l(On, void 0), m(), i.terminate && i.terminate();
            },
          }
        );
        function l(e, t, n) {
            ...
            switch (t[0]) {
              ...
              case Tn: {
                ...
                try {
                  ...
                  throw (l(In, [r, { name: e, message: t, stack: o }]), n);
                } finally {
                  e.release();
                }
                break;
              ...
              case Rn: {
                ...
                try {
                  ...
                  throw (l(Dn, [e, { name: t, message: r, stack: o }]), n);
                }
                break;
              }
            }
      ...
      function Vn() {
        const e = (function (e) {
          return { position: null, height: pn, ...(e || {}) };
        })(
          (function () {
            const e = (function () {
              try {
            ...
            return (
              ...
              (function () {
                ...
                })(new URLSearchParams(self.location.search).get(Un));
                return (
                  (function (e) {
      ...
      function qn(e) {
        !(function (e) {
          try {
            sessionStorage.setItem(Un, JSON.stringify(e));
          } catch {
            (t = Fn),
      ...
      const Bn = "web-pixels-helper-sandbox-handle",
        Kn = { height: "26px", width: "21px", top: "12px", left: "12px" },
        Hn = { height: "100%", width: "100%", top: "0px", left: "0px" };
      function Wn(e) {
      ...
      function Xn({ id: e, tagName: t, attributes: n, dataset: r, styles: o }) {
        ...
        return (
          ...
          $n(a, o.props, o.options),
          [a, !0]
        );
      }
      async function Gn({ containerSpec: e, iframeSpec: t }) {
        await new Promise((e) => {
          if (document.body) e();
          else {
            const t = () => {
            ...
            return Gn({
              containerSpec: {
                ...
                styles: {
                  ...
                  transition: `opacity ${hn}ms ease-in-out, height ${mn}ms ease-in-out, top ${mn}ms ease-in-out, box-shadow ${fn}ms`,
                },
      ...
      function Zn(e, t) {
        return {
          ...
          setHeight: ({ height: t }) =>
            new Promise((n, r) => {
              try {
                $n(e.container, { height: `${t}px` }, { important: !0 }),
                  qn({ ...Vn(), height: t }),
                  n(!0);
              } catch (o) {
                n(!1);
          ...
          async proceedWithoutConsent() {
            try {
              const { success: e } = await (function (e, t) {
                if (
                  (new ye().produce("setTrackingConsent", le),
                  (function (e) {
                    ...
                    if ("object" == typeof e) {
                      ...
                      const n = [
                        ...
                        B.EMAIL,
                        K.ROOT_DOMAIN,
                        K.CHECKOUT_ROOT_DOMAIN,
                        K.STOREFRONT_ROOT_DOMAIN,
                        K.STOREFRONT_ACCESS_TOKEN,
                        K.HEADLESS_STOREFRONT,
                        K.IS_EXTENSION_TOKEN,
                        K.METAFIELDS,
                      ];
                      for (const e of t)
                        if (!n.includes(e))
            ...
            init(r) {
              try {
                ...
                if (
                  (function (e, t) {
                    return (
                      (e.pixel.type === ze.Custom || e.pixel.type === ze.App) &&
                  ...
                  try {
                    qn({ ...i, pixel: s });
                    let o = !1;
                    const { shopId: c, surface: u = Fe.Unknown } = r,
                      l = It("helperLoad", {
                        version: He,
                    ...
                    Jn({
                      ...
                      .catch((e) => {
                        ...
                        const { shopId: t, surface: n = Fe.Unknown } = r;
                        Ft("helperLoad", {
                          version: He,
                          pageUrl: self.location.href,
                          surface: n,
                    ...
                    const { shopId: e, surface: t = Fe.Unknown } = r;
                    Ft("helperLoad", {
                      version: He,
                      pageUrl: self.location.href,
                      surface: t,
      ...
      class nr {
        constructor({
          ...
          (this.channelSubscribers = new Map()),
            ...
            (this.replayQueue = new dn(e, t)),
            (this.eligibility = null != r ? r : tr);
        }
        publish(e, t, n = {}) {
          var r;
      ...
      const ar = {
        ...
        sr = [ar.string, ar.number, ar.boolean, ar.undefined, ar.null],
        cr = (e) =>
          null === e
            ? ar.null
            : void 0 === e
      ...
      function ur(e) {
        ...
        return void 0 === e || r(e)
          ? {
              isValid: (function e(o, i = "root") {
                ...
                return (
                  s ||
                    ((n = i),
                    (t = `Value of type "${a}" at "${n}" must be one of the following types: ${sr.join(
                      ", "
                    )}.`)),
                  s
                );
          ...
          : ((n = "root"),
            (t = `Value of type "${cr(e)}" at "${n}" must be an object.`),
      ...
      function fr(e) {
        return pr(e) === Ue.Standard;
      }
      function mr(e) {
        return pr(e) === Ue.Dom;
      }
      function hr(e) {
        return pr(e) === Ue.AdvancedDom;
      }
      const vr = (e, t, n) => {
      ...
      const gr = new Map(),
        ...
        yr = (e) => ({
          ...
          context: br(),
          id: "string" == typeof e.id && e.id.length > 0 ? e.id : Yt(),
          seq: wr(e.name),
        });
      function xr(e, t, n = {}) {
        ...
        return yr({ id: r, name: e, data: t, type: pr(e) });
      }
      const Er = "all_standard_events",
        _r = "all_custom_events",
        Sr = "all_dom_events";
      ...
      function kr(e) {
        const t = new nr({
          ...
          n = new nr({ bufferSize: 1e3, subscribeAllKey: _r, eligibility: vr }),
          r = new nr({
            bufferSize: 1e3,
            replayKeep: "newest",
            subscribeAllKey: Sr,
            ...
            eligibility: (...e) =>
              ...
              ((e, t, n) => {
                ...
                const { pixelRuntimeConfig: r } = t || {},
                  ...
                  a = o?.includes(qe.AdvancedDomEvents);
                return Boolean(a && i === ze.App);
              })(...e),
          });
        return {
          publish(n, r, o) {
            ...
            if (!fr(n)) return !1;
            if ("checkout_completed" === n && lr() && "1" === sn(Ge)) return !1;
            const i = ur(r);
          ...
          publishCustomEvent(t, r, o) {
            ...
            const a = (function (e, t = null) {
              return yr({ name: e, customData: t, type: Ue.Custom });
            })(t, r);
            return (
              Ft("eventPublish", {
                version: He,
          ...
          publishDomEvent(e, t, n) {
            ...
            if (!mr(e) && !hr(e))
              throw new Ar(`Event name "${e}" is not a supported DOM Event`);
            if (hr(e) && !wt(yt)) return !1;
            const i = ur(t);
            if (!i.isValid)
              throw new Ar(
            ...
            const a = xr(e, t, n);
            return hr(e) ? o.publish(e, a) : r.publish(e, a);
          },
          subscribe(i, a, s = {}) {
            const c = Yt(),
              u = async (t) => {
                ...
                const n = {
                    ...
                    runtimeContext:
                      s.pixelRuntimeConfig?.runtimeContext || "unknown",
                    restrictions: s.pixelRuntimeConfig?.restrictions,
                    scriptVersion:
                      s.pixelRuntimeConfig?.scriptVersion || "unknown",
                ...
                let o;
                try {
                  await a.call(t, t), er.message("logEvent", r);
                } catch (f) {
                  (o = f),
                    er.message("logEvent", { ...r, status: "FAIL", error: o });
                }
                const u = pr(t.name),
                  l = {
                    version: He,
                  ...
                  d = o ? "FAILURE" : "SUCCESS",
                  p = o ? String(o) : void 0;
                if ([Ue.Dom, Ue.AdvancedDom].includes(u))
                  tt(1) &&
                  ...
                  let e;
                  fr(t.name) && (e = t?.data?.checkout?.token),
            ...
            if (hr(i)) return o.subscribe(i, u, s);
            if ("all_events" === i) {
              const e = t.subscribe(Er, u, s),
                o = n.subscribe(_r, u, s),
                i = r.subscribe(Sr, u, s);
              return () => {
                const t = e(),
                  n = o(),
                  r = i();
          ...
          analytics: {
            subscribe: (t, i, s) => (
              ...
              e.subscribe(t, i, {
                ...
                shopId: r,
                surface: o,
                scope: rr.WebPixelExtension,
              })
            ),
          },
          browser: {
            cookie: {
              get: async (e) => (e ? sn(e) ?? "" : on() ?? ""),
              set: async (e, t) => {
                if (t) {
                  const n = `${e}=${t}`;
                  document.cookie = n;
      ...
      async function jr(e) {
        ...
        switch (
          ...
          At("pixel:register", "start", { pixelId: s, source: c }),
          r.runtimeContext)
        ) {
          case Ve.Lax:
          case Ve.Strict:
            try {
              t = await (async function ({
                ...
                const c = `web-pixel-sandbox-${e.type}-${e.id}-${e.runtimeContext}-${Ye}`;
                if (e.runtimeContext === Ve.Lax && document.getElementById(c)) {
                  const t = new Dr();
                  throw (
                    (lt.notify(t, {
                      pixelId: e.id,
                ...
                switch (e.runtimeContext) {
                  case Ve.Strict:
                    [u, l] = await (async function ({
                      ...
                      n.match(/spin\.dev\/?/) &&
                        o.push("?fast_storefront_renderer=1");
                      const i = o.join(""),
                        a = new Worker(i, {
                          name: e,
                          type: "classic",
                            ...
                            a.removeEventListener("error", n),
                              t(
                                e?.filename && e?.lineno && e?.message
                                  ? new Or(e.message, i)
                                  : new Error(
                                      `Failed to load web worker for pixel ${r} with url ${i}}`
                                    )
                              );
                          };
                  ...
                  case Ve.Lax:
                    [u, l] = await (async function ({
                      ...
                      const { iframe: s } = await Gn({
                        ...
                        { promise: c, reject: u } = et();
                      let l;
                      const d = () => {
                        l = setTimeout(() => {
                          u(
                            new Error(
                              `Failed to load iframe for pixel ${o} with url ${a.join(
                                ""
                              )}}`
                            )
                          );
                      ...
                      return (
                        p.addEventListener("message", (e) => {
                          "remote-ui::ready" === e.data &&
                            (clearTimeout(l), s.removeEventListener("load", d));
                        }),
                        [p, c]
                      );
                    })({
                ...
                const d = Pn(u, { callable: ["initialize"] }),
                  p = Tr({
                    eventBus: t,
                    customerPrivacyEventBus: n,
                    webPixelConfig: e,
                ...
                const h =
                  ...
                  v = [
                    d.call
                      ...
                      .catch((e) => {
                        throw new Pr(e.toString(), e.stack ?? "");
                      }),
                  ];
                if (
                  (l && v.push(l), await Promise.race(v), Ye !== m.hashVersion)
                ) {
                  const t = new Error(
                    `The main bundle hash (${Ye}) does not match the sandbox hash (${m.hashVersion})`
                  );
                  throw (
                    (lt.notify(t, {
                      severity: "warning",
                      ...
                      shopId: r,
                      userAgent:
                        f.navigator.userAgent || self.navigator.userAgent,
          ...
          case Ve.Open:
            try {
              t = await (async function ({
                ...
                const { promise: s, resolve: c, reject: u } = et(),
                ...
                if (!self[Be]) {
                  const e = new Error(
                    `${Be} was not found on the global scope. ${Be}.createShopifyExtend() was not exposed to the window.`
                  );
                  return (
                    lt.notify(e, {
                ...
                if (!("createShopifyExtend" in self[Be])) {
                  const e = (e, t) => {
                    ...
                    try {
                      ...
                      (n = {}),
                        lt.notify(h, {
                          context:
                            "v0/createWebPixel/createWebPixelOpen/createShopifyExtend",
                          unhandled: !1,
                        });
                    }
                    ...
                    if (!a)
                      return (
                        u(new Error(`No openPixelFn found for ${i}.`)), null
                      );
                    const { resolve: s, reject: c, webPixelApi: l } = a();
                    return (
                      l || c(new Error(`No api found for pixel ${i}.`)),
                      Object.freeze({
                        extend: (e, t) => {
                          e !== Je && c(new Lr());
                          try {
                  ...
                  Jt(self[Be], "createShopifyExtend", {
                    value: e,
                    enumerable: !1,
                    writable: !1,
                    configurable: !1,
                ...
                return (
                  ...
                  (w = (e) => {
                    (e.dataset.pixelId = l),
                      ...
                      m &&
                        (p
                          ? ((e.integrity = p), (e.crossOrigin = "anonymous"))
                          : lt.notify(
                              new Error(
                                `Missing integrityHash for SRI-enabled open pixel of type ${d} with id ${l} and src ${b}`
                              ),
                              {
        ...
        const d = ir(r),
          { measurement: p } = St("pixel:register", { pixelId: s, source: c });
        n && !t
          ? er.message("logPixelRegister", {
              pixelUid: { id: s, type: r.type },
              status: "FAIL",
      ...
      const Fr = new Set();
      function zr() {
        document.removeEventListener("visibilitychange", zr);
        for (const e of Fr) e();
        Fr.clear();
      }
      function Vr() {
        return new Promise((e) => {
          if ((Fr.add(e), "visible" === document.visibilityState))
            return (
      ...
      const Br = () => (
        ...
        Kr = { capture: !0, passive: !0 };
      function Hr(e, t, n, r = {}) {
        const o = r.addEventListenerOptions
          ? { ...Kr, ...r.addEventListenerOptions }
          : Kr;
        try {
          ...
          return (
            e.addEventListener(t, i, Br() ? o : o.capture),
            () => {
              e.removeEventListener(t, i, Br() ? o : o.capture);
            }
          );
        } catch (i) {
          lt.notify(i, {
      ...
      const Yr = new RegExp(
        ...
        Gr = (e) => {
          ...
          if (
            Xr.includes(e.tagName.toUpperCase()) ||
            "exclude" === t ||
            ("hidden" in e && e.hidden)
          )
            return !0;
            ...
            ((e) => {
              ...
              return (
                ...
                Jr.some((t) => {
                  ...
                  return "string" == typeof n && n.match(Yr);
                })
              );
            })(e) &&
            (t.value = "******"),
      ...
      const oo = [
        ...
        io = oo.reduce((e, t) => ((e[t] = 0), e), {});
      let ao = 0;
      const so = new WeakMap();
      function co(e) {
        if (!e) return -1;
        let t = so.get(e);
        return void 0 === t && ((t = ao), so.set(e, t), (ao += 1)), t;
      }
      ...
      function lo(e) {
        ...
        if (!uo.has(e)) {
          ...
          for (; t && Gr(t); ) t = t.previousSibling;
          uo.set(e, {
            parentSerializationId: co(e.parentNode),
            prevSiblingSerializationId: co(t),
          });
        }
        return uo.get(e);
      }
      ...
      const fo = ["checkbox", "radio"];
      function mo(e) {
        const t = { nodeType: e.nodeType, serializationId: co(e) };
        if (e instanceof Element) {
          if (
            ((t.attributes = eo(e, [...e.getAttributeNames(), "value"])),
            e instanceof HTMLInputElement && fo.includes(e.type))
          ) {
          ...
          (n, { eventPrefix: r } = {}) =>
            Hr(window, e, (e) => {
              ...
              (o instanceof HTMLInputElement ||
                ...
                !Gr(o) &&
                (r ? n(`${r}${t}`, { node: mo(o) }) : n(t, { element: go(o) }));
            }),
        yo = wo("blur", "input_blurred"),
        xo = wo("focus", "input_focused"),
        Eo = wo("change", "input_changed"),
        _o = ["action", "id"],
        So = [
          yo,
          Eo,
          (e, { eventPrefix: t } = {}) =>
            Hr(
              ...
              (n) => {
                const r = n?.target;
                if (!(r instanceof Element) || Gr(r)) return;
                const o = t
                  ? ho(n, r)
                  : (function (e, t) {
                      return { element: ro(t), ...io, ...Wr(e, oo) };
                    })(n, r);
                e(`${t ?? ""}clicked`, o);
              },
              { throttleDelay: 50 }
          ...
          (e, { eventPrefix: t } = {}) =>
            Hr(window, "submit", (n) => {
              ...
              r instanceof HTMLFormElement &&
                !Gr(r) &&
                (t
                  ? e(`${t}form_submitted`, { node: mo(r) })
                  : e("form_submitted", {
                      element: {
                        ...eo(r, _o),
                        elements: Array.from(r.elements)
                          .filter(
                            (e) => vo.some((t) => e instanceof t) && !Gr(e)
                          )
                          .map((e) => go(e)),
                      },
                    }));
      ...
      n(6352);
      const Co = (e, t) =>
          Array.from(e).reduce((e, n) => (Gr(n) || e.push(t(n)), e), []),
        To = (e) => ({ node: mo(e), children: Co(e.childNodes, To), ...lo(e) });
      n(9943);
      const Io = [
          (e) => {
            let t = null;
          ...
          (e) =>
            Hr(
              ...
              (t) => {
                ...
                Gr(r) || e("advanced_dom_scrolled", { node: mo(r) });
              },
              { throttleDelay: 100 }
            ),
          (e) => {
            const t = [ko("cut", e), ko("paste", e), ko("copy", e)];
            return () => {
              t.forEach((e) => e());
            };
          },
            ...
            Hr(
              ...
              (t) => {
                ...
                n instanceof Element &&
                  !Gr(n) &&
                  e("advanced_dom_selection_changed", { node: mo(n) });
              },
              { throttleDelay: 250 }
            ),
          (e) => {
            const t = () => {
              e("advanced_dom_available", { root: To(self.document) });
            };
            return "loading" !== document.readyState
              ? (t(), () => {})
              : Hr(self.window, "DOMContentLoaded", t);
          },
          (e) => {
            const t = new MutationObserver(async (t) => {
              await Vr(),
                t.forEach((t) => {
                  if (Gr(t.target)) return;
                  const n = Co(
                    ...
                    r = (function (e) {
                      ...
                      if (Gr(e.target))
                        return e.removedNodes.forEach((e) => po(e)), [];
                      const t = Array.from(e.removedNodes).filter((e) => {
                        const { parentSerializationId: t } = lo(e);
                        return -1 !== t || (po(e), !1);
                      });
                      return Co(t, (e) => {
                        const t = mo(e);
                  ...
                  if ("characterData" === t.type) {
                    const { target: e } = t;
                    e instanceof Text && t.oldValue !== e.data && o.push(mo(e));
                  }
      ...
      !(function () {
        ...
        if (self[Be]) {
          ...
          try {
            ...
            r &&
              (n = Array.from(r.attributes).reduce(
                (e, t) => ((e[t.name] = t.value), e),
                {}
              ));
          } catch (r) {}
          const o = new Error(
            `WebPixelsManager: ${Be} global object is already defined`
          );
          return (
            lt.notify(o, {
              ...
              notes: `setupScriptElementAttributes: ${JSON.stringify(
                t
              )}, currentScriptElementAttributes: ${JSON.stringify(n)}`,
            }),
            self[Be]
          );
        }
        ...
        try {
              ...
              init(n) {
                ...
                if (No)
                  return (
                    lt.notify(
                      new Error(
                        `WebPixelsManager: ${Be} is being initialized multiple times`
                      ),
                      {
                  ...
                  v = (function () {
                    ...
                    return (
                      n.reverse().reduce((e, t) => {
                        ...
                        return (
                          (function (e) {
                            an(`${cn}=1; path=/; domain=${e}`);
                          })(n),
                          sn(cn) || r.push(n),
                          (function (e) {
                            an(
                              `${cn}=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT; domain=${e}`
                            );
                          })(n),
                          n
                        );
                ...
                c &&
                  (function () {
                    try {
                      self.sessionStorage.setItem(Qe, "true");
                    } catch {}
                  })(),
                  je();
                ...
                Dt(b),
                  (Mt = u),
                  (function (e = []) {
                    (Array.isArray(e) ? e : [e]).forEach((e) => gt.add(e));
                  })(s),
                  wt("a1498136") &&
                    l &&
                    !v.includes(l) &&
                    lt.notify(
                      ...
                      ),
                      {
                        ...
                        shopId: o,
                        pixelType: ze.Custom,
                        notes: `effectiveTopLevelDomain: ${l}, cookieRestrictedDomains: ${JSON.stringify(
                          v
                        )}`,
                      }
                    ),
                  (function () {
                    try {
                      return "true" === self.sessionStorage.getItem(Qe);
                    } catch {
                      return !1;
                    }
                  })() && er.init(n);
                ...
                (y = w),
                  window.addEventListener("pagehide", () => {
                    (y.payload.pageDuration =
                      St("page:session")?.measurement?.duration),
                      Ut(y),
                      zt({ skipXhr: !0 });
                  });
                const x = kr(n),
                  E = (function (e) {
                    ...
                    return {
                      publish(e, n, r) {
                        ...
                        if (e !== $.CONSENT_COLLECTED)
                          throw new Error(
                            `Expected event name to be a ${$.CONSENT_COLLECTED}, but got "${e}".`
                          );
                        return t.publish(e, n, r);
                      },
                      subscribe(n, r, o = {}) {
                        if (n !== $.CONSENT_COLLECTED)
                          throw new Error(
                ...
                try {
                  ...
                  if (/^web-pixel-sandbox/.test(self.name)) {
                    ...
                    throw ((_.library = "browser"), lt.notify(e, _), e);
                  }
                  if (!o) {
                    const e = new at("WebPixelsManager: shopId is required");
                    throw (lt.notify(e, _), e);
                  }
                  if (!b) {
                    const e = new at(
                  ...
                  i === Fe.CheckoutOneSdk && (d.length = 0);
                  const e = d.reduce(
                    (e, t) => {
                  ...
                  Promise.all(e.ready)
                    .then(() =>
                      (function (e) {
                        const { measurement: t } = St("completed");
                    ...
                    (function () {
                      if (!mt)
                        try {
                          document.addEventListener($.CONSENT_COLLECTED, ft),
                            (mt = !0);
                        } catch (r) {
                          lt.notify(r, {
                            context:
                    ...
                    i !== Fe.CheckoutOne && i !== Fe.CheckoutOneSdk
                      ? ((function (e, t, n) {
                          M(e, t),
                            (function (e, t) {
                              m((n) => {
                        ...
                        Ao(x.publishDomEvent))
                      : i !== Fe.CheckoutOneSdk &&
                        (function (e, t, n) {
                          O(e, t);
                        })(x.publish, a),
                    d.some(({ capabilities: e }) =>
                      (e || []).includes(qe.AdvancedDomEvents)
                    ) &&
                      wt(yt) &&
                      ((A = x.publishDomEvent),
                      Io.map((e) => e(A)),
                      Ao(x.publishDomEvent, { eventPrefix: "advanced_dom_" })),
                  ...
                  return (
                    (No = (function ({
                      ...
                      return {
                        ...
                        publishCustomEvent: (t, n, r = {}) =>
                          e.publishCustomEvent(t, n, r),
                        publishDomEvent: (t, n, r = {}) =>
                          e.publishDomEvent(t, n, r),
                        subscribe: (t, o, i) =>
                          e.subscribe(t, o, {
                            ...i,
                            shopId: n,
                    ...
                    })({ eventBus: x, visitorApi: t, shopId: o, surface: i })),
                    No
                  );
                } catch (r) {
                  return (
                    ...
                    self.console && "test" !== Ke && console.error(r),
                    (S.payload.status = "failed"),
                    (S.payload.errorMsg = r?.message),
                    Ut(S),
                    (w.payload.runtimeErrorCaught = "true"),
                    Oo
                  );
                }
                var A;
          ...
          return (
            Jt(
              self,
              Be,
              { value: o, writable: !1, configurable: !1, enumerable: !1 },
              !1
            ),
          ...
          return (
            r instanceof at ||
              lt.notify(r, { context: "v0/createWebPixelsManager" }),
            self.console && console.error(r),
            (n.payload.status = "manager-create-error"),
            (n.payload.errorMsg = r?.message),
            Ut(n, !0),
            { init: () => Oo }
          );
        }
