  ...
  var e = {
              ...
              return "{" == t
                ...
                ? (function (e) {
                    ...
                    return {
                      ...
                      cus: c,
                      purposes: {
                        [o.DataProcessingPurpose.ANALYTICS]: p(
                          o.DataProcessingPurpose.ANALYTICS
                        ),
                        [o.DataProcessingPurpose.PREFERENCES]: p(
                          o.DataProcessingPurpose.PREFERENCES
                        ),
                        [o.DataProcessingPurpose.MARKETING]: p(
                          o.DataProcessingPurpose.MARKETING
                        ),
                        [o.DataProcessingPurpose.SALE_OF_DATA]: p(
      ...
      8680: function (e, t, n) {
        ...
        t.storefrontApiUpdateTrackingConsent = function (e, t) {
          ...
          return fetch(`https://${l}/api/unstable/graphql.json`, f)
            .then((e) => {
            ...
            .then((a) => {
              ...
              const l = 31536e6,
                ...
                m =
                  null !==
                    (s =
                      null === (p = a.data.consentManagement) || void 0 === p
                        ? void 0
                        : p.customerAccountUrl) && void 0 !== s
                    ? s
                    : "";
              return (
                r.writeCookie(i.CONSENT_COOKIE_NAME, E, l, g),
                v &&
                  y &&
                  (r.writeCookie(u, E, _, v), r.writeCookie(d, E, _, y)),
                h !== E &&
                  (r.writeCookie(i.CONSENT_COOKIE_NAME, h, l, g),
                  v &&
                    y &&
                    (r.writeCookie(u, h, _, v), r.writeCookie(d, h, _, y))),
                o.dispatchEvents(e),
      ...
      9414: function (e, t, n) {
        ...
        (t.analyticsEvents = {
          ...
          testWpmFormPreventDefault:
            /^test[ _]?wpm[ _]?form[ _]?prevent[ _]?default$/i,
        }),
      ...
      1482: function (e, t) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.storefrontAnalyticsSchemaId = "storefront_customer_tracking/4.20"),
          (t.storefrontAnalyticsSchemaIdValidation =
      ...
      3988: function (e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.S2S =
            ...
            t.TEST_DEFAULT_PREVENTED_ADDED_PRODUCT_EVENT_NAME =
        ...
        (t.PAGE_RENDERED_EVENT_NAME = "page_rendered"),
          ...
          (t.PRODUCT_ADDED_TO_CART_LEGACY_EVENT_NAME =
            "test_product_added_to_cart_legacy"),
          (t.PRODUCT_ADDED_TO_CART_NEXT_EVENT_NAME =
          ...
          return (
            ...
            (n.prototype.addedProduct = function (e) {
              ...
              this.produceToMonorail({
                ...
                g.default.isEnabled(
                  g.SERVER_EMITTED_ADD_TO_CART_NEW_REPORTIFY_MIGRATION
                ) &&
                  this.produceToMonorail({
                        ...
                        i(
                          {
                            ...
                            asset_version_id:
                              "c7c842bc44047ce7d257cc1241a86b052c7eb5af",
      ...
      4252: function (e, t, n) {
        ...
        function g(e) {
          if (
            void 0 === o &&
            (!l.default.isEnabled(l.TREKKIE_COOKIE_DOMAIN_FIX) || T(e))
          )
            if (
              (function () {
        ...
        (t.metricsSchemaId = "trekkie_metrics/2.0"),
          ...
          (t.sendToBugsnag = function (e) {
            ...
            if (this.shouldSendToBugsnag()) {
              var n = "c7c842bc44047ce7d257cc1241a86b052c7eb5af",
                o = null,
                r = null,
                i = null;
              if (e.appConfig)
            ...
            return (
              ...
              (e.prototype.logAssetContext = function (e) {
                ...
                a.addBatchEvent({
                  ...
                  payload: {
                    build_id: "c7c842bc44047ce7d257cc1241a86b052c7eb5af",
              ...
              (e.prototype.getS2SEventId = function (e, t, n) {
                ...
                var s = {
                  ...
                  c =
                    e === _.TEST_DEFAULT_PREVENTED_ADDED_PRODUCT_EVENT_NAME ||
                    "Added Product Next" === e
                      ? "Added Product"
                      : e,
